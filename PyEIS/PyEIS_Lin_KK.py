...
def KK_RC4(w, Rs, R_values, t_values):
    ...
    """
    return Rs + (R_values[0] / (1 + w * 1j * t_values[0])) + (R_values[1] / (1 + w * 1j * t_values[1])) + (
                R_values[2] / (1 + w * 1j * t_values[2])) + (R_values[3] / (1 + w * 1j * t_values[3]))
...
def KK_RC6(w, Rs, R_values, t_values):
    ...
    return Rs + (R_values[0] / (1 + w * 1j * t_values[0])) + (R_values[1] / (1 + w * 1j * t_values[1])) + (
                R_values[2] / (1 + w * 1j * t_values[2])) + (R_values[3] / (1 + w * 1j * t_values[3])) + (
                       R_values[4] / (1 + w * 1j * t_values[4])) + (R_values[5] / (1 + w * 1j * t_values[5]))
...
def KK_RC8(w, Rs, R_values, t_values):
    ...
    return Rs + (R_values[0] / (1 + w * 1j * t_values[0])) + (R_values[1] / (1 + w * 1j * t_values[1])) + (
                R_values[2] / (1 + w * 1j * t_values[2])) + (R_values[3] / (1 + w * 1j * t_values[3])) + (
                       R_values[4] / (1 + w * 1j * t_values[4])) + (R_values[5] / (1 + w * 1j * t_values[5])) + (
                       R_values[6] / (1 + w * 1j * t_values[6])) + (R_values[7] / (1 + w * 1j * t_values[7]))
...
def KK_RC10(w, Rs, R_values, t_values):
    ...
    return Rs + (R_values[0] / (1 + w * 1j * t_values[0])) + (R_values[1] / (1 + w * 1j * t_values[1])) + (
                R_values[2] / (1 + w * 1j * t_values[2])) + (R_values[3] / (1 + w * 1j * t_values[3])) + (
                       R_values[4] / (1 + w * 1j * t_values[4])) + (R_values[5] / (1 + w * 1j * t_values[5])) + (
                       R_values[6] / (1 + w * 1j * t_values[6])) + (R_values[7] / (1 + w * 1j * t_values[7])) + (
                       R_values[8] / (1 + w * 1j * t_values[8])) + (R_values[9] / (1 + w * 1j * t_values[9]))
...
def KK_RC12(w, Rs, R_values, t_values):
    ...
    return Rs + (R_values[0] / (1 + w * 1j * t_values[0])) + (R_values[1] / (1 + w * 1j * t_values[1])) + (
                R_values[2] / (1 + w * 1j * t_values[2])) + (R_values[3] / (1 + w * 1j * t_values[3])) + (
                       ...
                       R_values[6] / (1 + w * 1j * t_values[6])) + (R_values[7] / (1 + w * 1j * t_values[7])) + (
                       R_values[8] / (1 + w * 1j * t_values[8])) + (R_values[9] / (1 + w * 1j * t_values[9])) + (
                       R_values[10] / (1 + w * 1j * t_values[10])) + (R_values[11] / (1 + w * 1j * t_values[11]))
...
def KK_RC14(w, Rs, R_values, t_values):
    ...
    return Rs + (R_values[0] / (1 + w * 1j * t_values[0])) + (R_values[1] / (1 + w * 1j * t_values[1])) + (
                R_values[2] / (1 + w * 1j * t_values[2])) + (R_values[3] / (1 + w * 1j * t_values[3])) + (
                       ...
                       R_values[8] / (1 + w * 1j * t_values[8])) + (R_values[9] / (1 + w * 1j * t_values[9])) + (
                       R_values[10] / (1 + w * 1j * t_values[10])) + (R_values[11] / (1 + w * 1j * t_values[11])) + (
                       R_values[12] / (1 + w * 1j * t_values[12])) + (R_values[13] / (1 + w * 1j * t_values[13]))
...
def KK_RC16(w, Rs, R_values, t_values):
    ...
    return Rs + (R_values[0] / (1 + w * 1j * t_values[0])) + (R_values[1] / (1 + w * 1j * t_values[1])) + (
                R_values[2] / (1 + w * 1j * t_values[2])) + (R_values[3] / (1 + w * 1j * t_values[3])) + (
                       ...
                       R_values[10] / (1 + w * 1j * t_values[10])) + (R_values[11] / (1 + w * 1j * t_values[11])) + (
                       R_values[12] / (1 + w * 1j * t_values[12])) + (R_values[13] / (1 + w * 1j * t_values[13])) + (
                       R_values[14] / (1 + w * 1j * t_values[14])) + (R_values[15] / (1 + w * 1j * t_values[15]))
...
def KK_RC18(w, Rs, R_values, t_values):
    ...
    return Rs + (R_values[0] / (1 + w * 1j * t_values[0])) + (R_values[1] / (1 + w * 1j * t_values[1])) + (
                R_values[2] / (1 + w * 1j * t_values[2])) + (R_values[3] / (1 + w * 1j * t_values[3])) + (
                       ...
                       R_values[12] / (1 + w * 1j * t_values[12])) + (R_values[13] / (1 + w * 1j * t_values[13])) + (
                       R_values[14] / (1 + w * 1j * t_values[14])) + (R_values[15] / (1 + w * 1j * t_values[15])) + (
                       R_values[16] / (1 + w * 1j * t_values[16])) + (R_values[17] / (1 + w * 1j * t_values[17]))
...
def KK_RC20(w, Rs, R_values, t_values):
    ...
    return Rs + (R_values[0] / (1 + w * 1j * t_values[0])) + (R_values[1] / (1 + w * 1j * t_values[1])) + (
                R_values[2] / (1 + w * 1j * t_values[2])) + (R_values[3] / (1 + w * 1j * t_values[3])) + (
                       ...
                       R_values[14] / (1 + w * 1j * t_values[14])) + (R_values[15] / (1 + w * 1j * t_values[15])) + (
                       R_values[16] / (1 + w * 1j * t_values[16])) + (R_values[17] / (1 + w * 1j * t_values[17])) + (
                       R_values[18] / (1 + w * 1j * t_values[18])) + (R_values[19] / (1 + w * 1j * t_values[19]))
...
def KK_RC22(w, Rs, R_values, t_values):
    ...
    return Rs + (R_values[0] / (1 + w * 1j * t_values[0])) + (R_values[1] / (1 + w * 1j * t_values[1])) + (
                R_values[2] / (1 + w * 1j * t_values[2])) + (R_values[3] / (1 + w * 1j * t_values[3])) + (
                       ...
                       R_values[16] / (1 + w * 1j * t_values[16])) + (R_values[17] / (1 + w * 1j * t_values[17])) + (
                       R_values[18] / (1 + w * 1j * t_values[18])) + (R_values[19] / (1 + w * 1j * t_values[19])) + (
                       R_values[20] / (1 + w * 1j * t_values[20])) + (R_values[21] / (1 + w * 1j * t_values[21]))
...
def KK_RC24(w, Rs, R_values, t_values):
    ...
    return Rs + (R_values[0] / (1 + w * 1j * t_values[0])) + (R_values[1] / (1 + w * 1j * t_values[1])) + (
                R_values[2] / (1 + w * 1j * t_values[2])) + (R_values[3] / (1 + w * 1j * t_values[3])) + (
                       ...
                       R_values[18] / (1 + w * 1j * t_values[18])) + (R_values[19] / (1 + w * 1j * t_values[19])) + (
                       R_values[20] / (1 + w * 1j * t_values[20])) + (R_values[21] / (1 + w * 1j * t_values[21])) + (
                       R_values[22] / (1 + w * 1j * t_values[22])) + (R_values[23] / (1 + w * 1j * t_values[23]))
...
def KK_RC26(w, Rs, R_values, t_values):
    ...
    return Rs + (R_values[0] / (1 + w * 1j * t_values[0])) + (R_values[1] / (1 + w * 1j * t_values[1])) + (
                R_values[2] / (1 + w * 1j * t_values[2])) + (R_values[3] / (1 + w * 1j * t_values[3])) + (
                       ...
                       R_values[20] / (1 + w * 1j * t_values[20])) + (R_values[21] / (1 + w * 1j * t_values[21])) + (
                       R_values[22] / (1 + w * 1j * t_values[22])) + (R_values[23] / (1 + w * 1j * t_values[23])) + (
                       R_values[24] / (1 + w * 1j * t_values[24])) + (R_values[25] / (1 + w * 1j * t_values[25]))
...
def KK_RC28(w, Rs, R_values, t_values):
    ...
    return Rs + (R_values[0] / (1 + w * 1j * t_values[0])) + (R_values[1] / (1 + w * 1j * t_values[1])) + (
                R_values[2] / (1 + w * 1j * t_values[2])) + (R_values[3] / (1 + w * 1j * t_values[3])) + (
                       ...
                       R_values[22] / (1 + w * 1j * t_values[22])) + (R_values[23] / (1 + w * 1j * t_values[23])) + (
                       R_values[24] / (1 + w * 1j * t_values[24])) + (R_values[25] / (1 + w * 1j * t_values[25])) + (
                       R_values[26] / (1 + w * 1j * t_values[26])) + (R_values[27] / (1 + w * 1j * t_values[27]))
...
def KK_RC30(w, Rs, R_values, t_values):
    ...
    return Rs + (R_values[0] / (1 + w * 1j * t_values[0])) + (R_values[1] / (1 + w * 1j * t_values[1])) + (
                R_values[2] / (1 + w * 1j * t_values[2])) + (R_values[3] / (1 + w * 1j * t_values[3])) + (
                       ...
                       R_values[24] / (1 + w * 1j * t_values[24])) + (R_values[25] / (1 + w * 1j * t_values[25])) + (
                       R_values[26] / (1 + w * 1j * t_values[26])) + (R_values[27] / (1 + w * 1j * t_values[27])) + (
                       R_values[28] / (1 + w * 1j * t_values[28])) + (R_values[29] / (1 + w * 1j * t_values[29]))
...
def KK_RC32(w, Rs, R_values, t_values):
    ...
    return Rs + (R_values[0] / (1 + w * 1j * t_values[0])) + (R_values[1] / (1 + w * 1j * t_values[1])) + (
                R_values[2] / (1 + w * 1j * t_values[2])) + (R_values[3] / (1 + w * 1j * t_values[3])) + (
                       ...
                       R_values[26] / (1 + w * 1j * t_values[26])) + (R_values[27] / (1 + w * 1j * t_values[27])) + (
                       R_values[28] / (1 + w * 1j * t_values[28])) + (R_values[29] / (1 + w * 1j * t_values[29])) + (
                       R_values[30] / (1 + w * 1j * t_values[30])) + (R_values[31] / (1 + w * 1j * t_values[31]))
...
def KK_RC34(w, Rs, R_values, t_values):
    ...
    return Rs + (R_values[0] / (1 + w * 1j * t_values[0])) + (R_values[1] / (1 + w * 1j * t_values[1])) + (
                R_values[2] / (1 + w * 1j * t_values[2])) + (R_values[3] / (1 + w * 1j * t_values[3])) + (
                       ...
                       R_values[28] / (1 + w * 1j * t_values[28])) + (R_values[29] / (1 + w * 1j * t_values[29])) + (
                       R_values[30] / (1 + w * 1j * t_values[30])) + (R_values[31] / (1 + w * 1j * t_values[31])) + (
                       R_values[32] / (1 + w * 1j * t_values[32])) + (R_values[33] / (1 + w * 1j * t_values[33]))
...
def KK_RC36(w, Rs, R_values, t_values):
    ...
    return Rs + (R_values[0] / (1 + w * 1j * t_values[0])) + (R_values[1] / (1 + w * 1j * t_values[1])) + (
                R_values[2] / (1 + w * 1j * t_values[2])) + (R_values[3] / (1 + w * 1j * t_values[3])) + (
                       ...
                       R_values[30] / (1 + w * 1j * t_values[30])) + (R_values[31] / (1 + w * 1j * t_values[31])) + (
                       R_values[32] / (1 + w * 1j * t_values[32])) + (R_values[33] / (1 + w * 1j * t_values[33])) + (
                       R_values[34] / (1 + w * 1j * t_values[34])) + (R_values[35] / (1 + w * 1j * t_values[35]))
...
def KK_RC38(w, Rs, R_values, t_values):
    ...
    return Rs + (R_values[0] / (1 + w * 1j * t_values[0])) + (R_values[1] / (1 + w * 1j * t_values[1])) + (
                R_values[2] / (1 + w * 1j * t_values[2])) + (R_values[3] / (1 + w * 1j * t_values[3])) + (
                       ...
                       R_values[32] / (1 + w * 1j * t_values[32])) + (R_values[33] / (1 + w * 1j * t_values[33])) + (
                       R_values[34] / (1 + w * 1j * t_values[34])) + (R_values[35] / (1 + w * 1j * t_values[35])) + (
                       R_values[36] / (1 + w * 1j * t_values[36])) + (R_values[37] / (1 + w * 1j * t_values[37]))
...
def KK_RC40(w, Rs, R_values, t_values):
    ...
    return Rs + (R_values[0] / (1 + w * 1j * t_values[0])) + (R_values[1] / (1 + w * 1j * t_values[1])) + (
                R_values[2] / (1 + w * 1j * t_values[2])) + (R_values[3] / (1 + w * 1j * t_values[3])) + (
                       ...
                       R_values[34] / (1 + w * 1j * t_values[34])) + (R_values[35] / (1 + w * 1j * t_values[35])) + (
                       R_values[36] / (1 + w * 1j * t_values[36])) + (R_values[37] / (1 + w * 1j * t_values[37])) + (
                       R_values[38] / (1 + w * 1j * t_values[38])) + (R_values[39] / (1 + w * 1j * t_values[39]))
...
def KK_RC42(w, Rs, R_values, t_values):
    ...
    return Rs + (R_values[0] / (1 + w * 1j * t_values[0])) + (R_values[1] / (1 + w * 1j * t_values[1])) + (
                R_values[2] / (1 + w * 1j * t_values[2])) + (R_values[3] / (1 + w * 1j * t_values[3])) + (
                       ...
                       R_values[36] / (1 + w * 1j * t_values[36])) + (R_values[37] / (1 + w * 1j * t_values[37])) + (
                       R_values[38] / (1 + w * 1j * t_values[38])) + (R_values[39] / (1 + w * 1j * t_values[39])) + (
                       R_values[40] / (1 + w * 1j * t_values[40])) + (R_values[41] / (1 + w * 1j * t_values[41]))
...
def KK_RC44(w, Rs, R_values, t_values):
    ...
    return Rs + (R_values[0] / (1 + w * 1j * t_values[0])) + (R_values[1] / (1 + w * 1j * t_values[1])) + (
                R_values[2] / (1 + w * 1j * t_values[2])) + (R_values[3] / (1 + w * 1j * t_values[3])) + (
                       ...
                       R_values[38] / (1 + w * 1j * t_values[38])) + (R_values[39] / (1 + w * 1j * t_values[39])) + (
                       R_values[40] / (1 + w * 1j * t_values[40])) + (R_values[41] / (1 + w * 1j * t_values[41])) + (
                       R_values[42] / (1 + w * 1j * t_values[42])) + (R_values[43] / (1 + w * 1j * t_values[43]))
...
def KK_RC46(w, Rs, R_values, t_values):
    ...
    return Rs + (R_values[0] / (1 + w * 1j * t_values[0])) + (R_values[1] / (1 + w * 1j * t_values[1])) + (
                R_values[2] / (1 + w * 1j * t_values[2])) + (R_values[3] / (1 + w * 1j * t_values[3])) + (
                       ...
                       R_values[40] / (1 + w * 1j * t_values[40])) + (R_values[41] / (1 + w * 1j * t_values[41])) + (
                       R_values[42] / (1 + w * 1j * t_values[42])) + (R_values[43] / (1 + w * 1j * t_values[43])) + (
                       R_values[44] / (1 + w * 1j * t_values[44])) + (R_values[45] / (1 + w * 1j * t_values[45]))
...
def KK_RC48(w, Rs, R_values, t_values):
    ...
    return Rs + (R_values[0] / (1 + w * 1j * t_values[0])) + (R_values[1] / (1 + w * 1j * t_values[1])) + (
                R_values[2] / (1 + w * 1j * t_values[2])) + (R_values[3] / (1 + w * 1j * t_values[3])) + (
                       ...
                       R_values[42] / (1 + w * 1j * t_values[42])) + (R_values[43] / (1 + w * 1j * t_values[43])) + (
                       R_values[44] / (1 + w * 1j * t_values[44])) + (R_values[45] / (1 + w * 1j * t_values[45])) + (
                       R_values[46] / (1 + w * 1j * t_values[46])) + (R_values[47] / (1 + w * 1j * t_values[47]))
...
def KK_RC50(w, Rs, R_values, t_values):
    ...
    return Rs + (R_values[0] / (1 + w * 1j * t_values[0])) + (R_values[1] / (1 + w * 1j * t_values[1])) + (
                R_values[2] / (1 + w * 1j * t_values[2])) + (R_values[3] / (1 + w * 1j * t_values[3])) + (
                       ...
                       R_values[44] / (1 + w * 1j * t_values[44])) + (R_values[45] / (1 + w * 1j * t_values[45])) + (
                       R_values[46] / (1 + w * 1j * t_values[46])) + (R_values[47] / (1 + w * 1j * t_values[47])) + (
                       R_values[48] / (1 + w * 1j * t_values[48])) + (R_values[49] / (1 + w * 1j * t_values[49]))
...
def KK_RC52(w, Rs, R_values, t_values):
    ...
    return Rs + (R_values[0] / (1 + w * 1j * t_values[0])) + (R_values[1] / (1 + w * 1j * t_values[1])) + (
                R_values[2] / (1 + w * 1j * t_values[2])) + (R_values[3] / (1 + w * 1j * t_values[3])) + (
                       ...
                       R_values[46] / (1 + w * 1j * t_values[46])) + (R_values[47] / (1 + w * 1j * t_values[47])) + (
                       R_values[48] / (1 + w * 1j * t_values[48])) + (R_values[49] / (1 + w * 1j * t_values[49])) + (
                       R_values[50] / (1 + w * 1j * t_values[50])) + (R_values[51] / (1 + w * 1j * t_values[51]))
...
def KK_RC54(w, Rs, R_values, t_values):
    ...
    return Rs + (R_values[0] / (1 + w * 1j * t_values[0])) + (R_values[1] / (1 + w * 1j * t_values[1])) + (
                R_values[2] / (1 + w * 1j * t_values[2])) + (R_values[3] / (1 + w * 1j * t_values[3])) + (
                       ...
                       R_values[48] / (1 + w * 1j * t_values[48])) + (R_values[49] / (1 + w * 1j * t_values[49])) + (
                       R_values[50] / (1 + w * 1j * t_values[50])) + (R_values[51] / (1 + w * 1j * t_values[51])) + (
                       R_values[52] / (1 + w * 1j * t_values[52])) + (R_values[53] / (1 + w * 1j * t_values[53]))
...
def KK_RC56(w, Rs, R_values, t_values):
    ...
    return Rs + (R_values[0] / (1 + w * 1j * t_values[0])) + (R_values[1] / (1 + w * 1j * t_values[1])) + (
                R_values[2] / (1 + w * 1j * t_values[2])) + (R_values[3] / (1 + w * 1j * t_values[3])) + (
                       ...
                       R_values[50] / (1 + w * 1j * t_values[50])) + (R_values[51] / (1 + w * 1j * t_values[51])) + (
                       R_values[52] / (1 + w * 1j * t_values[52])) + (R_values[53] / (1 + w * 1j * t_values[53])) + (
                       R_values[54] / (1 + w * 1j * t_values[54])) + (R_values[55] / (1 + w * 1j * t_values[55]))
...
def KK_RC58(w, Rs, R_values, t_values):
    ...
    return Rs + (R_values[0] / (1 + w * 1j * t_values[0])) + (R_values[1] / (1 + w * 1j * t_values[1])) + (
                R_values[2] / (1 + w * 1j * t_values[2])) + (R_values[3] / (1 + w * 1j * t_values[3])) + (
                       ...
                       R_values[52] / (1 + w * 1j * t_values[52])) + (R_values[53] / (1 + w * 1j * t_values[53])) + (
                       R_values[54] / (1 + w * 1j * t_values[54])) + (R_values[55] / (1 + w * 1j * t_values[55])) + (
                       R_values[56] / (1 + w * 1j * t_values[56])) + (R_values[57] / (1 + w * 1j * t_values[57]))
...
def KK_RC60(w, Rs, R_values, t_values):
    ...
    return Rs + (R_values[0] / (1 + w * 1j * t_values[0])) + (R_values[1] / (1 + w * 1j * t_values[1])) + (
                R_values[2] / (1 + w * 1j * t_values[2])) + (R_values[3] / (1 + w * 1j * t_values[3])) + (
                       ...
                       R_values[54] / (1 + w * 1j * t_values[54])) + (R_values[55] / (1 + w * 1j * t_values[55])) + (
                       R_values[56] / (1 + w * 1j * t_values[56])) + (R_values[57] / (1 + w * 1j * t_values[57])) + (
                       R_values[58] / (1 + w * 1j * t_values[58])) + (R_values[59] / (1 + w * 1j * t_values[59]))
...
def KK_RC62(w, Rs, R_values, t_values):
    ...
    return Rs + (R_values[0] / (1 + w * 1j * t_values[0])) + (R_values[1] / (1 + w * 1j * t_values[1])) + (
                R_values[2] / (1 + w * 1j * t_values[2])) + (R_values[3] / (1 + w * 1j * t_values[3])) + (
                       ...
                       R_values[56] / (1 + w * 1j * t_values[56])) + (R_values[57] / (1 + w * 1j * t_values[57])) + (
                       R_values[58] / (1 + w * 1j * t_values[58])) + (R_values[59] / (1 + w * 1j * t_values[59])) + (
                       R_values[60] / (1 + w * 1j * t_values[60])) + (R_values[61] / (1 + w * 1j * t_values[61]))
...
def KK_RC64(w, Rs, R_values, t_values):
    ...
    return Rs + (R_values[0] / (1 + w * 1j * t_values[0])) + (R_values[1] / (1 + w * 1j * t_values[1])) + (
                R_values[2] / (1 + w * 1j * t_values[2])) + (R_values[3] / (1 + w * 1j * t_values[3])) + (
                       ...
                       R_values[58] / (1 + w * 1j * t_values[58])) + (R_values[59] / (1 + w * 1j * t_values[59])) + (
                       R_values[60] / (1 + w * 1j * t_values[60])) + (R_values[61] / (1 + w * 1j * t_values[61])) + (
                       R_values[62] / (1 + w * 1j * t_values[62])) + (R_values[63] / (1 + w * 1j * t_values[63]))
...
def KK_RC66(w, Rs, R_values, t_values):
    ...
    return Rs + (R_values[0] / (1 + w * 1j * t_values[0])) + (R_values[1] / (1 + w * 1j * t_values[1])) + (
                R_values[2] / (1 + w * 1j * t_values[2])) + (R_values[3] / (1 + w * 1j * t_values[3])) + (
                       ...
                       R_values[60] / (1 + w * 1j * t_values[60])) + (R_values[61] / (1 + w * 1j * t_values[61])) + (
                       R_values[62] / (1 + w * 1j * t_values[62])) + (R_values[63] / (1 + w * 1j * t_values[63])) + (
                       R_values[64] / (1 + w * 1j * t_values[64])) + (R_values[65] / (1 + w * 1j * t_values[65]))
...
def KK_RC68(w, Rs, R_values, t_values):
    ...
    return Rs + (R_values[0] / (1 + w * 1j * t_values[0])) + (R_values[1] / (1 + w * 1j * t_values[1])) + (
                R_values[2] / (1 + w * 1j * t_values[2])) + (R_values[3] / (1 + w * 1j * t_values[3])) + (
                       ...
                       R_values[62] / (1 + w * 1j * t_values[62])) + (R_values[63] / (1 + w * 1j * t_values[63])) + (
                       R_values[64] / (1 + w * 1j * t_values[64])) + (R_values[65] / (1 + w * 1j * t_values[65])) + (
                       R_values[66] / (1 + w * 1j * t_values[66])) + (R_values[67] / (1 + w * 1j * t_values[67]))
...
def KK_RC70(w, Rs, R_values, t_values):
    ...
    return Rs + (R_values[0] / (1 + w * 1j * t_values[0])) + (R_values[1] / (1 + w * 1j * t_values[1])) + (
                R_values[2] / (1 + w * 1j * t_values[2])) + (R_values[3] / (1 + w * 1j * t_values[3])) + (
                       ...
                       R_values[64] / (1 + w * 1j * t_values[64])) + (R_values[65] / (1 + w * 1j * t_values[65])) + (
                       R_values[66] / (1 + w * 1j * t_values[66])) + (R_values[67] / (1 + w * 1j * t_values[67])) + (
                       R_values[68] / (1 + w * 1j * t_values[68])) + (R_values[69] / (1 + w * 1j * t_values[69]))
...
def KK_RC72(w, Rs, R_values, t_values):
    ...
    return Rs + (R_values[0] / (1 + w * 1j * t_values[0])) + (R_values[1] / (1 + w * 1j * t_values[1])) + (
                R_values[2] / (1 + w * 1j * t_values[2])) + (R_values[3] / (1 + w * 1j * t_values[3])) + (
                       ...
                       R_values[66] / (1 + w * 1j * t_values[66])) + (R_values[67] / (1 + w * 1j * t_values[67])) + (
                       R_values[68] / (1 + w * 1j * t_values[68])) + (R_values[69] / (1 + w * 1j * t_values[69])) + (
                       R_values[70] / (1 + w * 1j * t_values[70])) + (R_values[71] / (1 + w * 1j * t_values[71]))
...
def KK_RC74(w, Rs, R_values, t_values):
    ...
    return Rs + (R_values[0] / (1 + w * 1j * t_values[0])) + (R_values[1] / (1 + w * 1j * t_values[1])) + (
                R_values[2] / (1 + w * 1j * t_values[2])) + (R_values[3] / (1 + w * 1j * t_values[3])) + (
                       ...
                       R_values[68] / (1 + w * 1j * t_values[68])) + (R_values[69] / (1 + w * 1j * t_values[69])) + (
                       R_values[70] / (1 + w * 1j * t_values[70])) + (R_values[71] / (1 + w * 1j * t_values[71])) + (
                       R_values[72] / (1 + w * 1j * t_values[72])) + (R_values[73] / (1 + w * 1j * t_values[73]))
...
def KK_RC76(w, Rs, R_values, t_values):
    ...
    return Rs + (R_values[0] / (1 + w * 1j * t_values[0])) + (R_values[1] / (1 + w * 1j * t_values[1])) + (
                R_values[2] / (1 + w * 1j * t_values[2])) + (R_values[3] / (1 + w * 1j * t_values[3])) + (
                       ...
                       R_values[70] / (1 + w * 1j * t_values[70])) + (R_values[71] / (1 + w * 1j * t_values[71])) + (
                       R_values[72] / (1 + w * 1j * t_values[72])) + (R_values[73] / (1 + w * 1j * t_values[73])) + (
                       R_values[74] / (1 + w * 1j * t_values[74])) + (R_values[75] / (1 + w * 1j * t_values[75]))
...
def KK_RC78(w, Rs, R_values, t_values):
    ...
    return Rs + (R_values[0] / (1 + w * 1j * t_values[0])) + (R_values[1] / (1 + w * 1j * t_values[1])) + (
                R_values[2] / (1 + w * 1j * t_values[2])) + (R_values[3] / (1 + w * 1j * t_values[3])) + (
                       ...
                       R_values[72] / (1 + w * 1j * t_values[72])) + (R_values[73] / (1 + w * 1j * t_values[73])) + (
                       R_values[74] / (1 + w * 1j * t_values[74])) + (R_values[75] / (1 + w * 1j * t_values[75])) + (
                       R_values[76] / (1 + w * 1j * t_values[76])) + (R_values[77] / (1 + w * 1j * t_values[77]))
...
def KK_RC80(w, Rs, R_values, t_values):
    ...
    return Rs + (R_values[0] / (1 + w * 1j * t_values[0])) + (R_values[1] / (1 + w * 1j * t_values[1])) + (
                R_values[2] / (1 + w * 1j * t_values[2])) + (R_values[3] / (1 + w * 1j * t_values[3])) + (
                       ...
                       R_values[74] / (1 + w * 1j * t_values[74])) + (R_values[75] / (1 + w * 1j * t_values[75])) + (
                       R_values[76] / (1 + w * 1j * t_values[76])) + (R_values[77] / (1 + w * 1j * t_values[77])) + (
                       R_values[78] / (1 + w * 1j * t_values[78])) + (R_values[79] / (1 + w * 1j * t_values[79]))
...
def KK_RC4_fit(params, w, t_values):
    ...
    R4 = params['R4']
    return Rs + (R1 / (1 + w * 1j * t_values[0])) + (R2 / (1 + w * 1j * t_values[1])) + (
                R3 / (1 + w * 1j * t_values[2])) + (R4 / (1 + w * 1j * t_values[3]))
...
def KK_RC5_fit(params, w, t_values):
    ...
    R5 = params['R5']
    return Rs + (R1 / (1 + w * 1j * t_values[0])) + (R2 / (1 + w * 1j * t_values[1])) + (
                R3 / (1 + w * 1j * t_values[2])) + (R4 / (1 + w * 1j * t_values[3])) + (R5 / (1 + w * 1j * t_values[4]))
...
def KK_RC6_fit(params, w, t_values):
    ...
    return Rs + (R1 / (1 + w * 1j * t_values[0])) + (R2 / (1 + w * 1j * t_values[1])) + (
                R3 / (1 + w * 1j * t_values[2])) + (R4 / (1 + w * 1j * t_values[3])) + (
                       R5 / (1 + w * 1j * t_values[4])) + (R6 / (1 + w * 1j * t_values[5]))
...
def KK_RC8_fit(params, w, t_values):
    ...
    return Rs + (R1 / (1 + w * 1j * t_values[0])) + (R2 / (1 + w * 1j * t_values[1])) + (
                R3 / (1 + w * 1j * t_values[2])) + (R4 / (1 + w * 1j * t_values[3])) + (
                       R5 / (1 + w * 1j * t_values[4])) + (R6 / (1 + w * 1j * t_values[5])) + (
                       R7 / (1 + w * 1j * t_values[6])) + (R8 / (1 + w * 1j * t_values[7]))
...
def KK_RC10_fit(params, w, t_values):
    ...
    return Rs + (R1 / (1 + w * 1j * t_values[0])) + (R2 / (1 + w * 1j * t_values[1])) + (
                R3 / (1 + w * 1j * t_values[2])) + (R4 / (1 + w * 1j * t_values[3])) + (
                       R5 / (1 + w * 1j * t_values[4])) + (R6 / (1 + w * 1j * t_values[5])) + (
                       R7 / (1 + w * 1j * t_values[6])) + (R8 / (1 + w * 1j * t_values[7])) + (
                       R9 / (1 + w * 1j * t_values[8])) + (R10 / (1 + w * 1j * t_values[9]))
...
def KK_RC12_fit(params, w, t_values):
    ...
    return Rs + (R1 / (1 + w * 1j * t_values[0])) + (R2 / (1 + w * 1j * t_values[1])) + (
                R3 / (1 + w * 1j * t_values[2])) + (R4 / (1 + w * 1j * t_values[3])) + (
                       ...
                       R7 / (1 + w * 1j * t_values[6])) + (R8 / (1 + w * 1j * t_values[7])) + (
                       R9 / (1 + w * 1j * t_values[8])) + (R10 / (1 + w * 1j * t_values[9])) + (
                       R11 / (1 + w * 1j * t_values[10])) + (R12 / (1 + w * 1j * t_values[11]))
...
def KK_RC14_fit(params, w, t_values):
    ...
    return Rs + (R1 / (1 + w * 1j * t_values[0])) + (R2 / (1 + w * 1j * t_values[1])) + (
                R3 / (1 + w * 1j * t_values[2])) + (R4 / (1 + w * 1j * t_values[3])) + (
                       ...
                       R9 / (1 + w * 1j * t_values[8])) + (R10 / (1 + w * 1j * t_values[9])) + (
                       R11 / (1 + w * 1j * t_values[10])) + (R12 / (1 + w * 1j * t_values[11])) + (
                       R13 / (1 + w * 1j * t_values[12])) + (R14 / (1 + w * 1j * t_values[13]))
...
def KK_RC16_fit(params, w, t_values):
    ...
    return Rs + (R1 / (1 + w * 1j * t_values[0])) + (R2 / (1 + w * 1j * t_values[1])) + (
                R3 / (1 + w * 1j * t_values[2])) + (R4 / (1 + w * 1j * t_values[3])) + (
                       ...
                       R11 / (1 + w * 1j * t_values[10])) + (R12 / (1 + w * 1j * t_values[11])) + (
                       R13 / (1 + w * 1j * t_values[12])) + (R14 / (1 + w * 1j * t_values[13])) + (
                       R15 / (1 + w * 1j * t_values[14])) + (R16 / (1 + w * 1j * t_values[15]))
...
def KK_RC18_fit(params, w, t_values):
    ...
    return Rs + (R1 / (1 + w * 1j * t_values[0])) + (R2 / (1 + w * 1j * t_values[1])) + (
                R3 / (1 + w * 1j * t_values[2])) + (R4 / (1 + w * 1j * t_values[3])) + (
                       ...
                       R13 / (1 + w * 1j * t_values[12])) + (R14 / (1 + w * 1j * t_values[13])) + (
                       R15 / (1 + w * 1j * t_values[14])) + (R16 / (1 + w * 1j * t_values[15])) + (
                       R17 / (1 + w * 1j * t_values[16])) + (R18 / (1 + w * 1j * t_values[17]))
...
def KK_RC20_fit(params, w, t_values):
    ...
    return Rs + (R1 / (1 + w * 1j * t_values[0])) + (R2 / (1 + w * 1j * t_values[1])) + (
                R3 / (1 + w * 1j * t_values[2])) + (R4 / (1 + w * 1j * t_values[3])) + (
                       ...
                       R15 / (1 + w * 1j * t_values[14])) + (R16 / (1 + w * 1j * t_values[15])) + (
                       R17 / (1 + w * 1j * t_values[16])) + (R18 / (1 + w * 1j * t_values[17])) + (
                       R19 / (1 + w * 1j * t_values[18])) + (R20 / (1 + w * 1j * t_values[19]))
...
def KK_RC22_fit(params, w, t_values):
    ...
    return Rs + (R1 / (1 + w * 1j * t_values[0])) + (R2 / (1 + w * 1j * t_values[1])) + (
                R3 / (1 + w * 1j * t_values[2])) + (R4 / (1 + w * 1j * t_values[3])) + (
                       ...
                       R17 / (1 + w * 1j * t_values[16])) + (R18 / (1 + w * 1j * t_values[17])) + (
                       R19 / (1 + w * 1j * t_values[18])) + (R20 / (1 + w * 1j * t_values[19])) + (
                       R21 / (1 + w * 1j * t_values[20])) + (R22 / (1 + w * 1j * t_values[21]))
...
def KK_RC24_fit(params, w, t_values):
    ...
    return Rs + (R1 / (1 + w * 1j * t_values[0])) + (R2 / (1 + w * 1j * t_values[1])) + (
                R3 / (1 + w * 1j * t_values[2])) + (R4 / (1 + w * 1j * t_values[3])) + (
                       ...
                       R19 / (1 + w * 1j * t_values[18])) + (R20 / (1 + w * 1j * t_values[19])) + (
                       R21 / (1 + w * 1j * t_values[20])) + (R22 / (1 + w * 1j * t_values[21])) + (
                       R23 / (1 + w * 1j * t_values[22])) + (R24 / (1 + w * 1j * t_values[23]))
...
def KK_RC26_fit(params, w, t_values):
    ...
    return Rs + (R1 / (1 + w * 1j * t_values[0])) + (R2 / (1 + w * 1j * t_values[1])) + (
                R3 / (1 + w * 1j * t_values[2])) + (R4 / (1 + w * 1j * t_values[3])) + (
                       ...
                       R21 / (1 + w * 1j * t_values[20])) + (R22 / (1 + w * 1j * t_values[21])) + (
                       R23 / (1 + w * 1j * t_values[22])) + (R24 / (1 + w * 1j * t_values[23])) + (
                       R25 / (1 + w * 1j * t_values[24])) + (R26 / (1 + w * 1j * t_values[25]))
...
def KK_RC28_fit(params, w, t_values):
    ...
    return Rs + (R1 / (1 + w * 1j * t_values[0])) + (R2 / (1 + w * 1j * t_values[1])) + (
                R3 / (1 + w * 1j * t_values[2])) + (R4 / (1 + w * 1j * t_values[3])) + (
                       ...
                       R23 / (1 + w * 1j * t_values[22])) + (R24 / (1 + w * 1j * t_values[23])) + (
                       R25 / (1 + w * 1j * t_values[24])) + (R26 / (1 + w * 1j * t_values[25])) + (
                       R27 / (1 + w * 1j * t_values[26])) + (R28 / (1 + w * 1j * t_values[27]))
...
def KK_RC30_fit(params, w, t_values):
    ...
    return Rs + (R1 / (1 + w * 1j * t_values[0])) + (R2 / (1 + w * 1j * t_values[1])) + (
                R3 / (1 + w * 1j * t_values[2])) + (R4 / (1 + w * 1j * t_values[3])) + (
                       ...
                       R25 / (1 + w * 1j * t_values[24])) + (R26 / (1 + w * 1j * t_values[25])) + (
                       R27 / (1 + w * 1j * t_values[26])) + (R28 / (1 + w * 1j * t_values[27])) + (
                       R29 / (1 + w * 1j * t_values[28])) + (R30 / (1 + w * 1j * t_values[29]))
...
def KK_RC32_fit(params, w, t_values):
    ...
    return Rs + (R1 / (1 + w * 1j * t_values[0])) + (R2 / (1 + w * 1j * t_values[1])) + (
                R3 / (1 + w * 1j * t_values[2])) + (R4 / (1 + w * 1j * t_values[3])) + (
                       ...
                       R27 / (1 + w * 1j * t_values[26])) + (R28 / (1 + w * 1j * t_values[27])) + (
                       R29 / (1 + w * 1j * t_values[28])) + (R30 / (1 + w * 1j * t_values[29])) + (
                       R31 / (1 + w * 1j * t_values[30])) + (R32 / (1 + w * 1j * t_values[31]))
...
def KK_RC34_fit(params, w, t_values):
    ...
    return Rs + (R1 / (1 + w * 1j * t_values[0])) + (R2 / (1 + w * 1j * t_values[1])) + (
                R3 / (1 + w * 1j * t_values[2])) + (R4 / (1 + w * 1j * t_values[3])) + (
                       ...
                       R29 / (1 + w * 1j * t_values[28])) + (R30 / (1 + w * 1j * t_values[29])) + (
                       R31 / (1 + w * 1j * t_values[30])) + (R32 / (1 + w * 1j * t_values[31])) + (
                       R33 / (1 + w * 1j * t_values[32])) + (R34 / (1 + w * 1j * t_values[33]))
...
def KK_RC36_fit(params, w, t_values):
    ...
    return Rs + (R1 / (1 + w * 1j * t_values[0])) + (R2 / (1 + w * 1j * t_values[1])) + (
                R3 / (1 + w * 1j * t_values[2])) + (R4 / (1 + w * 1j * t_values[3])) + (
                       ...
                       R31 / (1 + w * 1j * t_values[30])) + (R32 / (1 + w * 1j * t_values[31])) + (
                       R33 / (1 + w * 1j * t_values[32])) + (R34 / (1 + w * 1j * t_values[33])) + (
                       R35 / (1 + w * 1j * t_values[34])) + (R36 / (1 + w * 1j * t_values[35]))
...
def KK_RC38_fit(params, w, t_values):
    ...
    return Rs + (R1 / (1 + w * 1j * t_values[0])) + (R2 / (1 + w * 1j * t_values[1])) + (
                R3 / (1 + w * 1j * t_values[2])) + (R4 / (1 + w * 1j * t_values[3])) + (
                       ...
                       R33 / (1 + w * 1j * t_values[32])) + (R34 / (1 + w * 1j * t_values[33])) + (
                       R35 / (1 + w * 1j * t_values[34])) + (R36 / (1 + w * 1j * t_values[35])) + (
                       R37 / (1 + w * 1j * t_values[36])) + (R38 / (1 + w * 1j * t_values[37]))
...
def KK_RC40_fit(params, w, t_values):
    ...
    return Rs + (R1 / (1 + w * 1j * t_values[0])) + (R2 / (1 + w * 1j * t_values[1])) + (
                R3 / (1 + w * 1j * t_values[2])) + (R4 / (1 + w * 1j * t_values[3])) + (
                       ...
                       R35 / (1 + w * 1j * t_values[34])) + (R36 / (1 + w * 1j * t_values[35])) + (
                       R37 / (1 + w * 1j * t_values[36])) + (R38 / (1 + w * 1j * t_values[37])) + (
                       R39 / (1 + w * 1j * t_values[38])) + (R40 / (1 + w * 1j * t_values[39]))
...
def KK_RC42_fit(params, w, t_values):
    ...
    return Rs + (R1 / (1 + w * 1j * t_values[0])) + (R2 / (1 + w * 1j * t_values[1])) + (
                R3 / (1 + w * 1j * t_values[2])) + (R4 / (1 + w * 1j * t_values[3])) + (
                       ...
                       R37 / (1 + w * 1j * t_values[36])) + (R38 / (1 + w * 1j * t_values[37])) + (
                       R39 / (1 + w * 1j * t_values[38])) + (R40 / (1 + w * 1j * t_values[39])) + (
                       R41 / (1 + w * 1j * t_values[40])) + (R42 / (1 + w * 1j * t_values[41]))
...
def KK_RC44_fit(params, w, t_values):
    ...
    return Rs + (R1 / (1 + w * 1j * t_values[0])) + (R2 / (1 + w * 1j * t_values[1])) + (
                R3 / (1 + w * 1j * t_values[2])) + (R4 / (1 + w * 1j * t_values[3])) + (
                       ...
                       R39 / (1 + w * 1j * t_values[38])) + (R40 / (1 + w * 1j * t_values[39])) + (
                       R41 / (1 + w * 1j * t_values[40])) + (R42 / (1 + w * 1j * t_values[41])) + (
                       R43 / (1 + w * 1j * t_values[42])) + (R44 / (1 + w * 1j * t_values[43]))
...
def KK_RC46_fit(params, w, t_values):
    ...
    return Rs + (R1 / (1 + w * 1j * t_values[0])) + (R2 / (1 + w * 1j * t_values[1])) + (
                R3 / (1 + w * 1j * t_values[2])) + (R4 / (1 + w * 1j * t_values[3])) + (
                       ...
                       R41 / (1 + w * 1j * t_values[40])) + (R42 / (1 + w * 1j * t_values[41])) + (
                       R43 / (1 + w * 1j * t_values[42])) + (R44 / (1 + w * 1j * t_values[43])) + (
                       R45 / (1 + w * 1j * t_values[44])) + (R46 / (1 + w * 1j * t_values[45]))
...
def KK_RC48_fit(params, w, t_values):
    ...
    return Rs + (R1 / (1 + w * 1j * t_values[0])) + (R2 / (1 + w * 1j * t_values[1])) + (
                R3 / (1 + w * 1j * t_values[2])) + (R4 / (1 + w * 1j * t_values[3])) + (
                       ...
                       R43 / (1 + w * 1j * t_values[42])) + (R44 / (1 + w * 1j * t_values[43])) + (
                       R45 / (1 + w * 1j * t_values[44])) + (R46 / (1 + w * 1j * t_values[45])) + (
                       R47 / (1 + w * 1j * t_values[46])) + (R48 / (1 + w * 1j * t_values[47]))
...
def KK_RC50_fit(params, w, t_values):
    ...
    return Rs + (R1 / (1 + w * 1j * t_values[0])) + (R2 / (1 + w * 1j * t_values[1])) + (
                R3 / (1 + w * 1j * t_values[2])) + (R4 / (1 + w * 1j * t_values[3])) + (
                       ...
                       R45 / (1 + w * 1j * t_values[44])) + (R46 / (1 + w * 1j * t_values[45])) + (
                       R47 / (1 + w * 1j * t_values[46])) + (R48 / (1 + w * 1j * t_values[47])) + (
                       R49 / (1 + w * 1j * t_values[48])) + (R50 / (1 + w * 1j * t_values[49]))
...
def KK_RC52_fit(params, w, t_values):
    ...
    return Rs + (R1 / (1 + w * 1j * t_values[0])) + (R2 / (1 + w * 1j * t_values[1])) + (
                R3 / (1 + w * 1j * t_values[2])) + (R4 / (1 + w * 1j * t_values[3])) + (
                       ...
                       R47 / (1 + w * 1j * t_values[46])) + (R48 / (1 + w * 1j * t_values[47])) + (
                       R49 / (1 + w * 1j * t_values[48])) + (R50 / (1 + w * 1j * t_values[49])) + (
                       R51 / (1 + w * 1j * t_values[50])) + (R52 / (1 + w * 1j * t_values[51]))
...
def KK_RC54_fit(params, w, t_values):
    ...
    return Rs + (R1 / (1 + w * 1j * t_values[0])) + (R2 / (1 + w * 1j * t_values[1])) + (
                R3 / (1 + w * 1j * t_values[2])) + (R4 / (1 + w * 1j * t_values[3])) + (
                       ...
                       R49 / (1 + w * 1j * t_values[48])) + (R50 / (1 + w * 1j * t_values[49])) + (
                       R51 / (1 + w * 1j * t_values[50])) + (R52 / (1 + w * 1j * t_values[51])) + (
                       R53 / (1 + w * 1j * t_values[52])) + (R54 / (1 + w * 1j * t_values[53]))
...
def KK_RC56_fit(params, w, t_values):
    ...
    return Rs + (R1 / (1 + w * 1j * t_values[0])) + (R2 / (1 + w * 1j * t_values[1])) + (
                R3 / (1 + w * 1j * t_values[2])) + (R4 / (1 + w * 1j * t_values[3])) + (
                       ...
                       R51 / (1 + w * 1j * t_values[50])) + (R52 / (1 + w * 1j * t_values[51])) + (
                       R53 / (1 + w * 1j * t_values[52])) + (R54 / (1 + w * 1j * t_values[53])) + (
                       R55 / (1 + w * 1j * t_values[54])) + (R56 / (1 + w * 1j * t_values[55]))
...
def KK_RC58_fit(params, w, t_values):
    ...
    return Rs + (R1 / (1 + w * 1j * t_values[0])) + (R2 / (1 + w * 1j * t_values[1])) + (
                R3 / (1 + w * 1j * t_values[2])) + (R4 / (1 + w * 1j * t_values[3])) + (
                       ...
                       R53 / (1 + w * 1j * t_values[52])) + (R54 / (1 + w * 1j * t_values[53])) + (
                       R55 / (1 + w * 1j * t_values[54])) + (R56 / (1 + w * 1j * t_values[55])) + (
                       R57 / (1 + w * 1j * t_values[56])) + (R58 / (1 + w * 1j * t_values[57]))
...
def KK_RC60_fit(params, w, t_values):
    ...
    return Rs + (R1 / (1 + w * 1j * t_values[0])) + (R2 / (1 + w * 1j * t_values[1])) + (
                R3 / (1 + w * 1j * t_values[2])) + (R4 / (1 + w * 1j * t_values[3])) + (
                       ...
                       R55 / (1 + w * 1j * t_values[54])) + (R56 / (1 + w * 1j * t_values[55])) + (
                       R57 / (1 + w * 1j * t_values[56])) + (R58 / (1 + w * 1j * t_values[57])) + (
                       R59 / (1 + w * 1j * t_values[58])) + (R60 / (1 + w * 1j * t_values[59]))
...
def KK_RC62_fit(params, w, t_values):
    ...
    return Rs + (R1 / (1 + w * 1j * t_values[0])) + (R2 / (1 + w * 1j * t_values[1])) + (
                R3 / (1 + w * 1j * t_values[2])) + (R4 / (1 + w * 1j * t_values[3])) + (
                       ...
                       R57 / (1 + w * 1j * t_values[56])) + (R58 / (1 + w * 1j * t_values[57])) + (
                       R59 / (1 + w * 1j * t_values[58])) + (R60 / (1 + w * 1j * t_values[59])) + (
                       R61 / (1 + w * 1j * t_values[60])) + (R62 / (1 + w * 1j * t_values[61]))
...
def KK_RC64_fit(params, w, t_values):
    ...
    return Rs + (R1 / (1 + w * 1j * t_values[0])) + (R2 / (1 + w * 1j * t_values[1])) + (
                R3 / (1 + w * 1j * t_values[2])) + (R4 / (1 + w * 1j * t_values[3])) + (
                       ...
                       R59 / (1 + w * 1j * t_values[58])) + (R60 / (1 + w * 1j * t_values[59])) + (
                       R61 / (1 + w * 1j * t_values[60])) + (R62 / (1 + w * 1j * t_values[61])) + (
                       R63 / (1 + w * 1j * t_values[62])) + (R64 / (1 + w * 1j * t_values[63]))
...
def KK_RC66_fit(params, w, t_values):
    ...
    return Rs + (R1 / (1 + w * 1j * t_values[0])) + (R2 / (1 + w * 1j * t_values[1])) + (
                R3 / (1 + w * 1j * t_values[2])) + (R4 / (1 + w * 1j * t_values[3])) + (
                       ...
                       R61 / (1 + w * 1j * t_values[60])) + (R62 / (1 + w * 1j * t_values[61])) + (
                       R63 / (1 + w * 1j * t_values[62])) + (R64 / (1 + w * 1j * t_values[63])) + (
                       R65 / (1 + w * 1j * t_values[64])) + (R66 / (1 + w * 1j * t_values[65]))
...
def KK_RC68_fit(params, w, t_values):
    ...
    return Rs + (R1 / (1 + w * 1j * t_values[0])) + (R2 / (1 + w * 1j * t_values[1])) + (
                R3 / (1 + w * 1j * t_values[2])) + (R4 / (1 + w * 1j * t_values[3])) + (
                       ...
                       R63 / (1 + w * 1j * t_values[62])) + (R64 / (1 + w * 1j * t_values[63])) + (
                       R65 / (1 + w * 1j * t_values[64])) + (R66 / (1 + w * 1j * t_values[65])) + (
                       R67 / (1 + w * 1j * t_values[66])) + (R68 / (1 + w * 1j * t_values[67]))
...
def KK_RC70_fit(params, w, t_values):
    ...
    return Rs + (R1 / (1 + w * 1j * t_values[0])) + (R2 / (1 + w * 1j * t_values[1])) + (
                R3 / (1 + w * 1j * t_values[2])) + (R4 / (1 + w * 1j * t_values[3])) + (
                       ...
                       R65 / (1 + w * 1j * t_values[64])) + (R66 / (1 + w * 1j * t_values[65])) + (
                       R67 / (1 + w * 1j * t_values[66])) + (R68 / (1 + w * 1j * t_values[67])) + (
                       R69 / (1 + w * 1j * t_values[68])) + (R70 / (1 + w * 1j * t_values[69]))
...
def KK_RC72_fit(params, w, t_values):
    ...
    return Rs + (R1 / (1 + w * 1j * t_values[0])) + (R2 / (1 + w * 1j * t_values[1])) + (
                R3 / (1 + w * 1j * t_values[2])) + (R4 / (1 + w * 1j * t_values[3])) + (
                       ...
                       R67 / (1 + w * 1j * t_values[66])) + (R68 / (1 + w * 1j * t_values[67])) + (
                       R69 / (1 + w * 1j * t_values[68])) + (R70 / (1 + w * 1j * t_values[69])) + (
                       R71 / (1 + w * 1j * t_values[70])) + (R72 / (1 + w * 1j * t_values[71]))
...
def KK_RC74_fit(params, w, t_values):
    ...
    return Rs + (R1 / (1 + w * 1j * t_values[0])) + (R2 / (1 + w * 1j * t_values[1])) + (
                R3 / (1 + w * 1j * t_values[2])) + (R4 / (1 + w * 1j * t_values[3])) + (
                       ...
                       R69 / (1 + w * 1j * t_values[68])) + (R70 / (1 + w * 1j * t_values[69])) + (
                       R71 / (1 + w * 1j * t_values[70])) + (R72 / (1 + w * 1j * t_values[71])) + (
                       R73 / (1 + w * 1j * t_values[72])) + (R74 / (1 + w * 1j * t_values[73]))
...
def KK_RC76_fit(params, w, t_values):
    ...
    return Rs + (R1 / (1 + w * 1j * t_values[0])) + (R2 / (1 + w * 1j * t_values[1])) + (
                R3 / (1 + w * 1j * t_values[2])) + (R4 / (1 + w * 1j * t_values[3])) + (
                       ...
                       R71 / (1 + w * 1j * t_values[70])) + (R72 / (1 + w * 1j * t_values[71])) + (
                       R73 / (1 + w * 1j * t_values[72])) + (R74 / (1 + w * 1j * t_values[73])) + (
                       R75 / (1 + w * 1j * t_values[74])) + (R76 / (1 + w * 1j * t_values[75]))
...
def KK_RC78_fit(params, w, t_values):
    ...
    return Rs + (R1 / (1 + w * 1j * t_values[0])) + (R2 / (1 + w * 1j * t_values[1])) + (
                R3 / (1 + w * 1j * t_values[2])) + (R4 / (1 + w * 1j * t_values[3])) + (
                       ...
                       R73 / (1 + w * 1j * t_values[72])) + (R74 / (1 + w * 1j * t_values[73])) + (
                       R75 / (1 + w * 1j * t_values[74])) + (R76 / (1 + w * 1j * t_values[75])) + (
                       R77 / (1 + w * 1j * t_values[76])) + (R78 / (1 + w * 1j * t_values[77]))
...
def KK_RC80_fit(params, w, t_values):
    ...
    return Rs + (R1 / (1 + w * 1j * t_values[0])) + (R2 / (1 + w * 1j * t_values[1])) + (
                R3 / (1 + w * 1j * t_values[2])) + (R4 / (1 + w * 1j * t_values[3])) + (
                       ...
                       R75 / (1 + w * 1j * t_values[74])) + (R76 / (1 + w * 1j * t_values[75])) + (
                       R77 / (1 + w * 1j * t_values[76])) + (R78 / (1 + w * 1j * t_values[77])) + (
                       R79 / (1 + w * 1j * t_values[78])) + (R80 / (1 + w * 1j * t_values[79]))
...
def KK_timeconst(w, num_RC):
    ...
    for j in range(len(num_RC)):
        ...
        t_initial.append(10 ** ((np.log10(t_min)) + (j - 1) / (len(num_RC) - 1) * np.log10(
            t_max / t_min)))  # initial guess parameter parameter tau for each -RC- circuit
    return t_initial
...
def KK_errorfunc_2(w, re, im, num_RC, t_values):
    ...
    if num_RC == 51:
        re_fit = curve_fit(
            lambda w, Rs, R1, R2, R3, R4, R5, R6, R7, R8, R9, R10, R11, R12, R13, R14, R15, R16, R17, R18, R19, R20,
                   R21, R22, R23, R24, R25, R26, R27, R28, R29, R30, R31, R32, R33, R34, R35, R36, R37, R38, R39, R40,
                   R41, R42, R43, R44, R45, R46, R47, R48, R49, R50, R51: KK_RC51_fit(w, Rs, R1, R2, R3, R4, R5, R6, R7,
